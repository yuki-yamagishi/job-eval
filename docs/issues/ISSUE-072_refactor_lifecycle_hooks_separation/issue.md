...
- **現在の問題点**:
  ...
  - 4軸ドキュメントの整合性検査が `preToolHook.js` と `scripts/checkers/issueDocChecker.js` で重複実装され、二重管理の負債となっている。
- **放置した場合のリスク**:
...
- 関連 ADR: `docs/adr/0017-lifecycle-hooks-governance.md`, `docs/adr/0020-fast-inner-loop-and-pre-impact-check.md`
