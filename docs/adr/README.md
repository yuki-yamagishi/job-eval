...
| [ADR-0029](file:///docs/adr/0029-submodule-automated-sync-workflow.md) | antigravity-review-loop プラグイン更新の完全自律 Pull 型自動検知・品質検証・PR 起票ワークフローの導入 | **Accepted** | 2026-09-18 |
