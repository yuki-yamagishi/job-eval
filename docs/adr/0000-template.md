# ADR-0000: [タイトル（例: ○○スコアリング計算式の改定 / 〇〇永続化形式の拡張）]

- **ステータス**: Proposed / Accepted / Rejected / Deprecated / Superceded by ADR-XXXX
- **決定日**: YYYY-MM-DD
- **決定者**: JobEval 開発チーム
...
<!-- なぜこの意思決定が必要になったのか、解決すべき求人評価上の課題や制約を記述 -->
